...
public class DebugManager : MonoBehaviour
{
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Alpha1))
        {
            ...
            result.Item1.Item1.tempName, result.Item1.Item2.tempIndex,
            result.Item2.Item1.tempName, result.Item2.Item2.tempIndex,
            result.Item3.Item1.tempName, result.Item3.Item2.tempIndex);
        }
    }
}